...
def test_build_timing_guide_basic():
    segments = [
        ...
        },
        {
            ...
            "text_vi": "Đây là một câu rất dài dài dài",
            "start": 2.5,
            "end": 4.5,
            "duration": 2.0,
        },
    ...
    guide = build_timing_guide(
        segments, durations, target_field="text_vi", source_url="https://youtu.be/123"
    )
...
def test_build_timing_guide_empty_and_none():
    ...
    segments = [
        {"id": 1, "text": "Hi", "text_vi": "Chào", "start": 0.0, "end": 1.0, "duration": 1.0}
    ]
