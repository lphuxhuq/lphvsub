...
FIELDS: tuple[Field, ...] = (
    ...
    Field(
        "ASR_GAP_RESCAN",
        CHECK,
        "Quét lại khoảng lặng bắt lời bị bỏ sót",
        TAB_BASIC,
        "Nghe và chép lời video gốc",
        "true",
    ...
    Field(
        ...
        "Hiển thị",
        "",
        "Tên này hiện ở lời chào trên Trang chủ. Để trống thì dùng tên đăng nhập của máy.",
    ...
    Field(
        ...
        "Kiểu chữ",
        "40",
        "Khoảng cách từ chữ tới mép trên hoặc mép dưới.",
        suffix=" điểm ảnh",
        minimum=0,
        maximum=400,
        step=5,
    ...
    Field(
        ...
        "Kiểu chữ",
        "0",
        "Bóng nhẹ phía sau chữ. Đặt 0 để tắt.",
        minimum=0,
        maximum=8,
        step=1,
        decimals=0,
    ...
    Field(
        ...
        TAB_SUBTITLE,
        "Kiểu chữ",
        tokens.SUBTITLE_OUTLINE_DEFAULT,
    ...
    Field(
        ...
        TAB_SUBTITLE,
        "Nền chữ",
        tokens.SUBTITLE_BOXFILL_DEFAULT,
        "Màu của khối nền sau chữ.",
    ),
    Field(
    ...
    Field(
        ...
        TAB_SUBTITLE,
        "Hiện theo cụm chữ",
        tokens.SUBTITLE_HIGHLIGHT_DEFAULT,
        "Màu tô lên cụm chữ đang được đọc.",
    ),
    Field(
        "KARAOKE_ALIGNMENT",
        CHECK,
        "Canh chữ theo lời đọc",
        TAB_SUBTITLE,
        "Hiện theo cụm chữ",
        "true",
    ...
    Field(
        "AUTO_MASK_HARDSUB",
        CHECK,
        "Tự động phát hiện và làm mờ phụ đề gốc",
        TAB_SUBTITLE,
        "Làm mờ phụ đề gốc",
        "false",
    ...
    Field(
        ...
        "Hiệu năng",
        "0",
        "Đặt 0 để ứng dụng tự chọn theo cấu hình máy. Chỉ đổi khi bạn biết rõ mình cần gì.",
        minimum=0,
        maximum=32,
        step=1,
        decimals=0,
    ...
    Field(
        ...
        NUMBER,
        "Số video tải trước trong hàng đợi",
        TAB_PERF,
        "Tải video",
        "2",
    ...
    Field(
        "DOWNLOAD_PAGE_WORKERS",
        NUMBER,
        "Số video tải cùng lúc",
        TAB_PERF,
        "Tải video",
        "2",
    ...
    Field(
        "SMART_FLIP",
        CHECK,
        "Lật gương thông minh (Smart Flip)",
        TAB_ADVANCED,
        "Chống quét bản quyền (Anti-Content ID)",
        "false",
    ...
    Field(
        "MICRO_ZOOM",
        CHECK,
        "Zoom động & Trượt góc máy (Micro-zoom)",
        TAB_ADVANCED,
        "Chống quét bản quyền (Anti-Content ID)",
        "false",
    ...
    Field(
        "COLOR_FILTER",
        COMBO,
        "Bộ lọc màu điện ảnh (Color Grading)",
        TAB_ADVANCED,
        "Chống quét bản quyền (Anti-Content ID)",
        "none",
    ...
    Field(
        "RANDOMIZE_METADATA",
        CHECK,
        "Đổi mã băm MD5 & Làm sạch Metadata",
        TAB_ADVANCED,
        "Chống quét bản quyền (Anti-Content ID)",
        "true",
    ...
    Field(
        "TRANSLATE_CPS_BUDGET",
        SLIDER,
        "Số chữ mỗi giây",
        TAB_ADVANCED,
        "Chất lượng dịch",
        "12.5",
        "Giới hạn độ dài câu dịch để đọc kịp. Càng nhỏ thì câu càng ngắn gọn.",
        minimum=8.0,
        maximum=20.0,
        step=0.5,
        decimals=1,
    ...
    Field(
        "ORIGINAL_VOICE_DUCK_DB",
        SLIDER,
        "Giảm tiếng gốc khi nhân vật nói",
        TAB_ADVANCED,
        "Xử lý âm thanh",
        "-16.0",
    ...
    Field(
        "VOICE_FIT_STRETCH",
        CHECK,
        "Kéo dài giọng đọc lấp khoảng lặng",
        TAB_ADVANCED,
        "Căn thời gian",
        "false",
    ...
    Field(
        "AUTO_CLEAN_INTERMEDIATES",
        CHECK,
        "Tự dọn tệp trung gian sau khi xuất",
        TAB_ADVANCED,
        "Dung lượng đĩa",
        "false",
    ...
    Field(
        ...
        "Dịch tự động",
        "40",
        "Lô nhỏ hơn thì chậm hơn một chút nhưng mạch dịch bám ngữ cảnh sát hơn.",
        minimum=1,
        maximum=100,
        step=5,
        decimals=0,
    ...
    Field(
        "TRANSLATE_THINKING",
        CHECK,
        "Để AI suy nghĩ kỹ trước khi dịch",
        TAB_TRANSLATE,
        "Dịch tự động",
        "false",
    ...
    Field(
        ...
        "Ngữ cảnh video",
        "",
        "Càng cụ thể thì bản dịch càng đúng ngữ cảnh. Để trống thì máy chủ tự đoán từ lời thoại.",
    ...
    Field(
        ...
        placeholder="ví dụ: Kênh đập hộp linh kiện máy tính giá rẻ, người xem là dân tự lắp máy.",
    ),
    Field(
        "TRANSLATE_PRONOUNS",
        TEXT,
    ...
    Field(
        "GENERATE_METADATA",
        CHECK,
        "Tạo tiêu đề, mô tả và thẻ cho mạng xã hội",
        TAB_TRANSLATE,
        "Nội dung đăng bài",
        "true",
    ...
    Field(
        "AI_STUDIO_HEADLESS",
        CHECK,
        "Chạy ẩn Chrome khi dịch",
        TAB_TRANSLATE,
        "Dịch qua AI Studio (Trình duyệt)",
        "false",
        "Bật: Chrome chạy ngầm (headless). Tắt: hiển thị cửa sổ Chrome để quan sát quá trình dịch.",
    ),
    Field(
        "AI_STUDIO_SINGLE_CHAT",
        CHECK,
        "Dịch toàn bộ trong 1 cuộc trò chuyện",
        TAB_TRANSLATE,
        "Dịch qua AI Studio (Trình duyệt)",
        "true",
    ...
    Field(
        "AI_STUDIO_CHROME_PROFILE",
        TEXT,
        "Thư mục Chrome Profile",
        TAB_TRANSLATE,
        "Dịch qua AI Studio (Trình duyệt)",
        "",
