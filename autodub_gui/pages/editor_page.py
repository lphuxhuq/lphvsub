...
class EditorPage(VoiceAndExportMixin, BasePage):
    ...
    def _save_render_opts(self) -> None:
        ...
        opts["logo_custom_x"] = getattr(self, "_logo_custom_x", 0.5)
        opts["logo_custom_y"] = getattr(self, "_logo_custom_y", 0.5)
        ...
        opts["watermark_custom_x"] = getattr(self, "_watermark_custom_x", 0.5)
        opts["watermark_custom_y"] = getattr(self, "_watermark_custom_y", 0.5)
