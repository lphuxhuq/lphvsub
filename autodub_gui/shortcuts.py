...
EDITOR_SHORTCUTS: tuple[Shortcut, ...] = (
    ...
    Shortcut("Ctrl+B", "Tách câu tại vị trí con trỏ phát", "Trình chỉnh sửa"),
    Shortcut("Ctrl+J", "Gộp câu đang chọn với câu liền sau", "Trình chỉnh sửa"),
...
def install_editor_shortcuts(page) -> list[QShortcut]:
    ...
    created = [
        ...
        bind(page, "Ctrl+B", page.split_current_segment),
        bind(page, "Ctrl+J", page.merge_current_segment),
